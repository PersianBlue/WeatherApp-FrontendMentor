...
export default function CurrentForecast({
  ...
  const apparent_temp = weatherData?.current.apparent_temperature ?? "--";
  const rel_humidity = weatherData?.current.relative_humidity_2m ?? "--";
  const precipitation = weatherData?.current.precipitation ?? "--";
  const wind_speed = weatherData?.current.wind_speed_10m ?? "--";
  // if (loading) {
  //   return (
  //     <div className="weatherInfoContainer skeleton">
  //       <div className="weatherInfo skeleton">
